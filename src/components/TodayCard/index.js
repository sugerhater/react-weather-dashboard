...
const TodayCard = () => {
  ...
  const [{city,uvi}] = useStoreContext();
    ...
    cityInfo.name ? (
      ...
      (<div className="card pl-3 pt-3 mb-3 bg-primary text-light">
        <div className="card-body">
          ...
          {/* <div className="city">{cityInfo.main.humidity}</div>
      <div className="temp">{`Temperature:${(cityInfo.main.pressure * 9 / 5 - 459.67).toFixed(1)}`}</div> */}
